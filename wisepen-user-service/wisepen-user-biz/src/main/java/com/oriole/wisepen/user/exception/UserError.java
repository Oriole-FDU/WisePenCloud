...
public enum UserError implements IResult {
    ...
    VERIFICATION_EMAIL_FUDAN_NOT_ALLOWED(3314, new ResultKey(BusinessDomain.USER, UserSubject.AUTH_VERIFICATION, ErrorReason.NOT_ALLOWED),"复旦邮箱不能通过教育邮箱认证，请使用复旦 UIS 认证"),
