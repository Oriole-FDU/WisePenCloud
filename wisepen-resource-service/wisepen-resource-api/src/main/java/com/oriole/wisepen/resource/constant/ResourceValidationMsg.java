...
public interface ResourceValidationMsg {
    ...
    // Market 相关校验
    String MARKET_SALE_TIER_PRICE_NOT_NULL = "售卖档位价格不能为空";
    String MARKET_SALE_TIER_PRICE_INVALID = "售卖档位价格必须大于0";
    String MARKET_SALE_TIER_LIST_NOT_EMPTY = "至少需要提供一个售卖档位";
    String MARKET_SALE_VERSION_NOT_NULL = "上架版本不能为空";
    String MARKET_SALE_VERSION_INVALID = "上架版本必须大于0";
    String MARKET_SALE_TIER_ID_NOT_BLANK = "售卖档位ID不能为空";
    String MARKET_REVIEW_CONTENT_PERCENTAGE_INVALID = "预览内容比例必须在0到100之间";
    String MARKET_AUDIT_STATUS_NOT_NULL = "审核目标状态不能为空";
